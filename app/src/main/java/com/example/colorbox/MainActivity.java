...
import static com.example.colorbox.R.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mColor = ContextCompat.getColor( this, color.default_background);
        mTextViewCountDown.setBackgroundColor(mColor);
    ...
    private void startTimer() {
        ...
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                mTimerRunning = false;
                mTextViewCountDown.setBackgroundColor(Color.parseColor("#0080ff"));
